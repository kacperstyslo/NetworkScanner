...
class UserInfo:
    def __init__(self):
        ...
        self.user_ip = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        self.user_ip.connect(("8.8.8.8", 80))
        self.user_ip = self.user_ip.getsockname()[0]
...
class NetworkScannerModuleQuick(UserInfo):
    ...
    @staticmethod
    def network_scanner_quick_module_start():
        Clear.clear()
...
class NetworkScannerModuleIntense(NetworkScanner, UserInfo):
    ...
    @staticmethod
    def network_scanner_module_intense_start():
        Clear.clear()
...
class Parser:
    ...
    def main():
        ...
        parser.add_argument('-q', dest='quick', action='store_true', help="shows now")
        parser.add_argument('-i', dest='intense', action='store_true', help="shows now")
        parser.add_argument('-s', dest='single_target', action='store_true', help="shows now")
      ...
      |==========================================================================================|                    
            ...
            NetworkScanner().single_target_menu()
